...
begin
  ...
  FIndexConn := commons.backend.connect.Connected;
  FConn := TSimpleQueryFiredac.New(commons.backend.connect.FConnList.Items
    [FIndexConn]);
...
begin
  FDataSource.Free;
  commons.backend.connect.Disconnected(FIndexConn);
  inherited;
end;
